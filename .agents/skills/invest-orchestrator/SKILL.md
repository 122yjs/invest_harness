...
게이트 산출물은 `_workspace/00_input/input-intake.md`다. 이 파일에는 사용자 원문, 자동 식별 결과, 사용자에게 되물을 선택 옵션, 선택 입력인 특정 이벤트 / 촉매, 기본값, 게이트 결과를 남긴다.
...
먼저 사용자가 제공한 원문 입력을 보존하고, 입력 수집 게이트를 통과한 뒤 아래 항목을 `_workspace/00_input/request-summary.md`에 정규화한다.
...
9. 그 외 항목은 기본값으로 적용하되 `_workspace/00_input/request-summary.md`에 남긴다.
10. `docs/harness/invest/templates/input-intake.md` 형식으로 `_workspace/00_input/input-intake.md`를 작성한다.

완료 기준:

- `_workspace/00_input/input-intake.md`가 존재한다.
...
5. `docs/harness/invest/templates/request-summary.md` 형식으로 `_workspace/00_input/request-summary.md`를 작성한다.

완료 기준:

- 기업명 또는 티커 기반 자동 식별이 완료되어 있다.
- `_workspace/00_input/input-intake.md`의 게이트 결과가 요약되어 있다.
