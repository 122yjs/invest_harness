...
<!-- GENERATED-SYNC: source=plugins/vertical-plugins/invest-research/skills/valuation-analyst/SKILL.md; kind=skill; script=scripts/sync_invest_skills.py -->
> [!IMPORTANT]
...
- **역할**: 본 analyst가 수행
- **출력**: `${ACTIVE_WORKSPACE}/03_valuation/report.md`
- **내용**: findings를 바탕으로 한 밸류에이션 해석, 멀티플/DCF 가정 타당성 논의, 시나리오별 투자 함의
- **핵심 질문**: "이 밸류에이션이 투자적으로 무슨 의미인가(So What)"
