...
7. **파일 저장**
   - 최종 결과를 `${ACTIVE_WORKSPACE}/05_macro_sentiment/findings.md`와 `${ACTIVE_WORKSPACE}/05_macro_sentiment/report.md`에 저장한다.
...
- **역할**: 본 analyst가 수행
- **출력**: `${ACTIVE_WORKSPACE}/05_macro_sentiment/report.md`
- **내용**: findings를 바탕으로 한 뉴스/센티먼트 해석, 거시정책 영향, 주가에 미치는 함의
- **핵심 질문**: "이 센티먼트와 거시환경이 투자적으로 무슨 의미인가(So What)"
