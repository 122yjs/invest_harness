...
2. **섹션별 Report (01~06/report.md)**: `section-report-writer`가 작성 — findings 기반 정성 해석 ("이 파트에서 왜 중요한가")
...
> **원칙**: Findings는 "무엇인가"를, 섹션별 Report는 "이 파트에서 왜 중요한가"를 (section-report-writer가 담당), 최종 Report는 "그래서 전체적으로 무엇인가"를 담당한다.
