...
$requiredPaths = @(
    ...
    @{ Path = 'plugins\vertical-plugins\invest-research\policies\report-writing-style-policy.md'; Description = 'Report Writing Style Policy Source' },
    @{ Path = 'plugins\agent-plugins\invest-harness\policies\report-writing-style-policy.md'; Description = 'Report Writing Style Policy Agent Plugin Copy' },
    @{ Path = '.agents\policies\report-writing-style-policy.md'; Description = 'Report Writing Style Policy Agent Copy' },
    ...
    @{ Path = 'scripts\test_portable_env_mcp.py'; Description = 'Python portable env and MCP wrapper tests' },
    @{ Path = 'scripts\Set-Credentials.ps1'; Description = 'PowerShell credential registration script' },
    @{ Path = 'scripts\env\Import-HarnessEnv.ps1'; Description = 'PowerShell .env loader' },
    @{ Path = 'scripts\mcp\Start-McpServer.ps1'; Description = 'PowerShell MCP wrapper core' },
    @{ Path = 'scripts\mcp\Start-KoreaStockMcp.ps1'; Description = 'PowerShell korea-stock MCP wrapper' },
    @{ Path = 'scripts\mcp\Start-YFinanceMcp.ps1'; Description = 'PowerShell yfinance MCP wrapper' },
