<!-- GENERATED-SYNC: source=plugins/vertical-plugins/invest-research/policies/rating-price-target-policy.md; kind=policy; script=scripts/sync_invest_skills.py -->
> [!IMPORTANT]
