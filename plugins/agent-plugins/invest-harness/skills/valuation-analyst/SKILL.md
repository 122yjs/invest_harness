...
<!-- GENERATED-SYNC: source=plugins/vertical-plugins/invest-research/skills/valuation-analyst/SKILL.md; kind=skill; script=scripts/Sync-InvestSkills.ps1 -->
> [!IMPORTANT]
...
| 기업 | 티커 | PER | Forward PER | PBR | EV/EBITDA | PSR | 영업이익률 | 매출 성장률 | 평가 |
|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 대상 기업 |  |  |  |  |  |  |  |  |  |
| 비교기업 1 |  |  |  |  |  |  |  |  |  |
| 비교기업 2 |  |  |  |  |  |  |  |  |  |
