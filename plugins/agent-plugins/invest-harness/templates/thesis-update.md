<!-- GENERATED-SYNC: source=plugins/vertical-plugins/invest-research/templates/thesis-update.md; kind=template; script=scripts/sync_invest_skills.py -->
> [!IMPORTANT]
