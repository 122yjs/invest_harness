<!-- GENERATED-SYNC: source=plugins/vertical-plugins/invest-research/templates/qa-final-check.md; kind=template; script=scripts/sync_invest_skills.py -->
> [!IMPORTANT]
...
| Review file | `${ACTIVE_WORKSPACE}/09_qa/review.md` |
| Fix list | `${ACTIVE_WORKSPACE}/09_qa/fix-list.md` |

| 항목 | 상태 | 비고 |
|---|---|---|
| 치명 결함 없음 |  |  |
| Rating / Price Target 근거 확인 |  |  |
