<!-- GENERATED-SYNC: source=plugins/vertical-plugins/invest-research/templates/comps.md; kind=template; script=scripts/sync_invest_skills.py -->
> [!IMPORTANT]
...
| 기업 | 티커 | PER | Forward PER | PBR | PSR | EV/EBITDA | EV/Sales | FCF Yield | 매출 성장률 | 영업이익률 | 비고 |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 대상 기업 |  |  |  |  |  |  |  |  |  |  |  |
