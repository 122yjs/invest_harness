<!-- GENERATED-SYNC: source=plugins/vertical-plugins/invest-research/templates/screen-criteria.md; kind=template; script=scripts/sync_invest_skills.py -->
> [!IMPORTANT]
...
| Thesis Fit | 0-5 |  |
| Market Tailwind | 0-5 |  |
| Financial Quality | 0-5 |  |
| Valuation / Risk-Reward | 0-5 |  |
| Catalyst Clarity | 0-5 |  |
| Data Confidence | 0-5 |  |
