<!-- GENERATED-SYNC: source=plugins/vertical-plugins/invest-research/templates/dcf.md; kind=template; script=scripts/sync_invest_skills.py -->
> [!IMPORTANT]
...
| Company / ticker |  |
| 기준일 |  |
| Market price snapshot | `${ACTIVE_WORKSPACE}/00_input/market-price-snapshot.md` |
| Comps input | `${ACTIVE_WORKSPACE}/03_valuation/comps.md` |

## Assumptions

| 항목 | Bear | Base | Bull | 근거 / 출처 |
|---|---:|---:|---:|---|
| 매출 성장률 |  |  |  |  |
| 영업이익률 |  |  |  |  |
| FCF 성장률 |  |  |  |  |
...
| 시나리오 | 주당가치 | 기준 주가 대비 괴리 | implied EV/EBITDA | 주요 조건 |
|---|---:|---:|---:|---|
| Bear |  |  |  |  |
| Base |  |  |  |  |
| Bull |  |  |  |  |
