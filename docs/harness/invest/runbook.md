...
8. `docs/harness/invest/templates/input-intake.md`를 기준으로 `_workspace/00_input/input-intake.md`를 작성한다.
...
6. `docs/harness/invest/templates/request-summary.md`를 기준으로 `_workspace/00_input/request-summary.md`를 작성한다.

필수 확인:

- `_workspace/00_input/input-intake.md`에 게이트 결과가 남아 있는지 확인한다.
